...
def menu():
 ...
 /__\\/_\\/__\\
	...
	17. Decypher a caesar cypher text
	""")
...
def hello():
	...
	print ("Hello", inpStr+"!", "It's a pleasure to meet you.")
...
def age_to_seconds():
	...
	years = int(inp)
	sec = years * 356 * 60 * 60
	print("You are over", format(sec, ",d"), "seconds old!")
...
def print_random_numbers():
	...
	maximum = int(maxStr)
	for _ in range(10):
		print(random.randint(minimum, maxinum), end=", ")
	print("")
...
def guess_the_number():
	...
	while True:
		...
		try:
			...
			print("You're wasting your guesses. Please enter a numeric value.")
...
def to_caesar():
	"""
	Encrypts text with a given ceasar chiper
	"""
	inp = input("How much shift to you want?\n")
	shift = int(inp)
	chars = string.ascii_lowercase[shift:] + string.ascii_lowercase[:shift]
	trans = str.maketrans(string.ascii_lowercase, chars)
	inp = input("Enter text you want to encode:\n")
	caesar_text = inp.lower().translate(trans)
	print(caesar_text)
